...
import ec.edu.puce.elecciones.formulario.ReporteCiudad;
import ec.edu.puce.elecciones.formulario.ReporteProvincia;
	...
	public MenuPrincipal() {
		...
		mntmResultadosPorProvincia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ReporteProvincia rg = new ReporteProvincia(prefectos);
				desktopPane.add(rg);
				rg.setVisible(true);
			}
		});
		...
		mntmResultadosPorCantn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ReporteCiudad rg = new ReporteCiudad(prefectos);
				desktopPane.add(rg);
				rg.setVisible(true);
			}
		});
